...
export const LAYOUTS = {
  ...
  stacked: { columns: 4, practice: 24, mixed: 16 },
  // Needs room underneath for partial products / a fourth column of digits.
  stackedWide: { columns: 3, practice: 12, mixed: 9 },
  // Facts: `7 × 8 = ☐`.
  horizontal: { columns: 3, practice: 30, mixed: 21 },
  // Bracket with work space below — division is never stacked like a subtraction.
  longDivision: { columns: 3, practice: 12, mixed: 9 },
  // Worded bank items; prompts run two to three lines.
  prompt: { columns: 2, practice: 12, mixed: 10 },
  // A chart is ~15 text lines tall.
  figure: { columns: 2, practice: 4, mixed: 3 },
};
