/* The skill catalog — what a parent prints and what a kid practices.
 *
 * ONE list, two surfaces: /worksheets and play both read it, so "Subtract
 * 3-digit numbers with regrouping" is the same skill on paper and on screen
 * (skillCatalogParity.spec). Lives in src/skills/; src/worksheets/ re-exports it.
 *
